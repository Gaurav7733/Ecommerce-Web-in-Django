...
class BaseView(EcomMixin,TemplateView):
    template_name = "base.html"

class AllProductsViews(EcomMixin,TemplateView):
...
class CustomerRegistrationView(EcomMixin,CreateView):
    template_name = "customerrigestration.html"
...
class CustomerLoginView(FormView):
    ...
    success_url = reverse_lazy("app:home")
    # Form_Valid method is a type of post method and is available in createview formview and updateiew
    def form_valid(self, form):
